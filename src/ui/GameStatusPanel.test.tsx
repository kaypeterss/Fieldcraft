...
describe('game status turn display', () => {
  ...
  it('shows an action with its round and human-readable turn context', () => {
    ...
    expect(screen.getByText(/Standard Infantry · Player 1 · R3\/T1/)).toBeTruthy()
    expect(screen.getByText('10 models · 32 mm circle')).toBeTruthy()
    expect(screen.getByText('3 models · Hull 105 × 44 mm')).toBeTruthy()
  })
})
