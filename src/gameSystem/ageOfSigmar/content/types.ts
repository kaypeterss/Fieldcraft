...
export interface AosWeaponProfile { name: string; range?: number; attacks: string; hit: number; wound: number; rend: number; damage: string; abilities?: string[] }
export interface AosWarscrollProfile {
  ...
  unitSize: number; footprint: Footprint; keywords: string[]; weapons: AosWeaponProfile[]; source: AosSourceMetadata
}
